...
export default function AcademicDocumentViewer({ document, snipping, onStopSnipping, onSnip, onSelectionAction }) {
  ...
  return (
    <section className={`al-viewer ${snipping ? 'is-snipping' : ''}`} ref={viewerRef} onMouseUp={handleMouseUp}>
      {!document ? (
        ...
        <iframe className="al-pdf-frame" src={`${document.preview_url}#toolbar=1&navpanes=1&scrollbar=1&view=FitH`} title={document.title || 'PDF preview'} />
