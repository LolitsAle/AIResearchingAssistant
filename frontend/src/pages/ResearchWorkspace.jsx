...
function DocumentsPanel({ documents, selectedDocumentIds, onToggleDocument, onSelectAllReady, onCreateSession, onUpload, uploadProgress, uploadError, onDismissUploadError, loadingDocuments, leftTab, onLeftTab, onPrompt, onGenerateFlashcards, onGenerateQuiz, quickLoading, onOpenLibrary, flashcardCount, onFlashcardCount, quizCount, onQuizCount }) {
