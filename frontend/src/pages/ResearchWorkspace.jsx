...
function NotesPanel({ notes, loading, filter, onFilter, onSaveEdit, onDelete, onExportMarkdown, onCitation, onOpenFlashcards, onOpenQuiz }) {
  const [detail, setDetail] = useState(null);
