...
function PasswordField({ label, value, onChange, required = false, disabled = false, autoComplete }) {
    ...
    <label>
      ...
      <span className="password-input-wrap">
        <input
          ...
          minLength={label === 'Mật khẩu hiện tại' ? undefined : 6}
          value={value}
          onChange={onChange}
          required={required}
          disabled={disabled}
  ...
  return (
    <section className="grid two">
      <form className="card form" onSubmit={changePassword}>
        ...
        <p className="muted">Luồng này yêu cầu mật khẩu hiện tại và luôn thử cập nhật bằng phiên đăng nhập hiện tại nếu quyền admin backend bị giới hạn.</p>
      </form>
