  ...
  return (
    <main className="reset-page">
      ...
      <section className="reset-card">
        ...
        <p className="muted">Nhận OTP 4 số qua email tài khoản rồi đặt mật khẩu mới. Môi trường develop có thể dùng mã test 8888.</p>
        ...
        {step === 2 ? (
          <form onSubmit={confirmReset}>
            <label>OTP 4 số<input inputMode="numeric" pattern="\d{4}" maxLength={4} required value={otp} onChange={(e) => setOtp(e.target.value.replace(/\D/g, '').slice(0, 4))} placeholder="8888" /></label>
